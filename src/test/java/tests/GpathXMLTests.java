...
import static endpoints.EndPointsVideoGamesAPI.*;
...
public class GpathXMLTests extends VideoGameConfig {
    ...
    public void getFirstGameInList() {
        ...
        Response response = get(GET_LIST_OF_ALL_VIDEO_GAMES);
    ...
    public void getListOfXmlNodes() {
        ...
        String responseAsString = get(GET_LIST_OF_ALL_VIDEO_GAMES).asString();
